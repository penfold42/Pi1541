...
public:
	...
	void WriteChar(bool petscii, u8 fontPx, u32 x, u32 y, unsigned char c, RGBA colour);
	u32 PrintText(bool petscii, u8 fontPx, u32 xPos, u32 yPos, char *ptr, RGBA TxtColour = RGBA(0xff, 0xff, 0xff, 0xff), RGBA BkColour = RGBA(0, 0, 0, 0xFF), bool measureOnly = false, u32* width = 0, u32* height = 0);
	u32 MeasureText(bool petscii, u8 fontPx, char *ptr, u32* width = 0, u32* height = 0);
